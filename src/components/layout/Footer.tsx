        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <p className="text-[14px] leading-relaxed mb-6 text-white/60">
              ...
              precious metals and gemstones. Each creation is a testament to
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[15px] font-semibold uppercase tracking-[2px] text-white mb-6">
              Quick Links
            </h4>
        ...
        <div className="max-w-[1400px] mx-auto px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            {["visa", "mastercard", "amex", "paypal"].map((payment) => (
              <div
                key={payment}
                className="w-10 h-6 bg-white/10 rounded flex items-center justify-center text-[9px] uppercase tracking-wider text-white/40"
              >
                {payment.slice(0, 4)}
              </div>
            ))}

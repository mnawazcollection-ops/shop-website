  ...
  const features = [
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <path d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.25h1.5a.75.75 0 01.75.75v3.75a.75.75 0 01-.75.75h-1.5a.75.75 0 01-.75-.75V8.25a.75.75 0 01.75-.75z" />
          <path d="M4.5 14.25v-8.25a.75.75 0 01.75-.75h9a.75.75 0 01.75.75v8.25" />
        </svg>
      ),
      title: "Free Safe Delivery",
      description: "Free insured delivery across Pakistan on orders over Rs. 50,000",
    },
    {
      ...
      description: "Safe checkout with cards, bank transfer, and Cash on Delivery",
    },
    {
      ...
      title: "Real Gold & Diamonds",
      description: "Certified 18K/21K/22K real gold & genuine lab-tested diamonds",
    },
    {
      ...
      description: "Friendly customer service available via call and WhatsApp",
    },
  ];
